...
fid_paths = [
		'/media/evl/Public/Mahyar/ganist_lsun_logs/layer_stats/fid_levels/real_fidlevels_logs/fid_levels.cpk',
		'/media/evl/Public/Mahyar/ganist_lsun_logs/layer_stats/fid_levels/1_fidlevels_logs/run_%d/fid_levels.cpk'#,
...
if __name__ == '__main__':
	...
	### plot
	pnames = ['real', 'wganbn']#, 'wganbn_fc', 'wganbn_conv1', 'wganbn_conv2', 'wganbn_conv3']
	pcolors = [0, 1]#, 2, 3, 4, 5]
	for i, p in enumerate(fid_paths):
		plot_fid_levels(ax, p, pnames[i], global_color_set[pcolors[i]])
	
	ax.legend(loc=0)
	fig.savefig('/media/evl/Public/Mahyar/ganist_lsun_logs/layer_stats/plots/fid_levels_mean_wganbn_real.pdf')