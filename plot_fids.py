...
fid_paths = [
	...
	'/media/evl/Public/Mahyar/ganist_lap_logs/0_logs_wganbn_lap3_celeba128cc/lasteval/run_%d/fid_levels.cpk',
	'/media/evl/Public/Mahyar/ganist_lap_logs/2_logs_wganbn_lap3_celeba128cc_popos/lasteval/run_%d/fid_levels.cpk'
...
if __name__ == '__main__':
	...
	### plot
	pnames = ['real', 'wganbn', 'lap3_wganbn_lasteval', 'lap3_wganbn_lasteval_popos']
	pcolors = [0, 1, 2, 3, 4] ## add 0 for real
	for i, p in enumerate(fid_paths):
		plot_fid_levels(ax, p, pnames[i], global_color_set[pcolors[i]])
	
	ax.legend(loc=0)
	fig.savefig('/media/evl/Public/Mahyar/ganist_lap_logs/plots/fids_wganbn_lap3_lasteval_vspopos_celeba128cc_g41.pdf')